(function () {
    ...
    const menuLinks = document.querySelectorAll(".botnav .container .maincard .card");
    ...
    function positionTarget(link) {
      ...
      target.style.top = `${link.classList.contains("active") ? 850 : link.offsetTop - 4}px`;
    ...
    function resizeFunc() {
      ...
      const active = document.querySelector(".maincard .card");
    ...
    document.getElementById("activateButton").addEventListener("click", function () {
      ...
      const homeLink = document.querySelector(".maincard .card");
